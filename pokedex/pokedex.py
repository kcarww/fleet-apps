...
async def main(page: ft.Page):
    ...
    luz_azul = ft.Container(width=60, height=60, left=5, top=5, bgcolor=ft.colors.BLUE, border_radius=50)
    boton_azul = ft.Stack([
        ft.Container(width=70, height=70, bgcolor=ft.colors.WHITE, border_radius=50),
        luz_azul,
        ]
    )
    ...
    stack_central = ft.Stack(
        [
            ft.Container(width=500, height=300, bgcolor=ft.colors.WHITE, border_radius=20),
    ...
    items_inferior = [
        ...
        ft.Container(texto, padding=10, width=300, height=200, bgcolor=ft.colors.GREEN, border_radius=20),
        ft.Container(width=30), #Margen derecho
        ft.Container(flechas, width=80, height=120),
        
    ]

    superior = ft.Container(content=ft.Row(items_superior),width=600,height=80, margin = ft.margin.only(top=20, left=30))
    centro = ft.Container(stack_central, width=600,height=400, margin = ft.margin.only(top=20), alignment=ft.alignment.center)
    inferior = ft.Container(content=ft.Row(items_inferior), width=600,height=200, margin = ft.margin.only(bottom=30))
    ...
    contenedor = ft.Container(col, width=600, height=800, bgcolor=ft.colors.RED, alignment=ft.alignment.top_center)
